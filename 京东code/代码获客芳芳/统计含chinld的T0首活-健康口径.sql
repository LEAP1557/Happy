...
from(
    ...
    where
      dt = '2021-08-08' --取最新的时间、今天是8月9日就填写2021-08-08
      and substr(loan_time, 1, 10) between '2021-08-01'
      and '2021-08-01' --取要查询的时间
      and substr(actvtime, 1, 10) = substr(loan_time, 1, 10)
      and (
