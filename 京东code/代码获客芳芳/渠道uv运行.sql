...
from
  (
    ...
    where
      ...
      and '2021-09-21' --时间修改
      and (
        -- note_key_id like '%SAS_GUIDE_INIT,H5,NEW_GUIDE_PAGE2%'
        note_key_id like '%SAS_GUIDE_INIT,H5,STD_ACT_FRESH_PAGE%'
        or note_key_id like '%SAS_GUIDE_INIT,newPage,H5,actExtension%'
